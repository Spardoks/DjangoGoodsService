...
- ToDo: все эндпоинты по спецификации - более строгая проверка
...
- ToDo: разделить тесты api по файлам для упрощения их дальнейшего написания и анализа, а также убрать тестовые эндпоинты
