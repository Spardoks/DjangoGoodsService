...
- Вход [In progress ...]
- Регистрация [In progress ...]
- Список товаров [Not done]
- Корзина (просмотр, добавление, удаление) [Not done]
- Контакты (просмотр, добавление, удаление) [Not done]
- Подтверждение заказа [Not done]
- Заказы просмотр списка [Not done]
