...
- [x] Вход
- [x] Регистрация
- Список товаров [In progress ...]
- Корзина (просмотр, добавление, удаление) [In progress ...]
- Контакты (просмотр, добавление, удаление) [In progress ...]
- Подтверждение заказа [Not done]
- Заказы, просмотр списка для пользователя-владельца магазина [Not done]
